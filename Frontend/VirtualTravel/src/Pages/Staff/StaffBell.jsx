...
export default function StaffBell() {
  ...
  useEffect(() => {
    ...
    const conn = getNotificationConnection((payload) => {
      console.log("%c[SignalR-Staff] New notification:", "color:#16a34a", payload);
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {unread > 0 && (
          <span className="absolute -top-0.5 -right-0.5 min-w-5 h-5 px-1 flex items-center justify-center bg-red-500 text-white text-xs rounded-full shadow">
            {unread}
          </span>
        )}
      </button>
      ...
      {open && (
        ...
        >
          <div className="flex items-center justify-between px-4 py-2 border-b bg-gradient-to-r from-emerald-50 to-blue-50">
            <span className="font-semibold text-gray-800">Thông báo nhân viên</span>
                  ...
                  >
                    <div className="flex justify-between gap-3">
                      <div className="min-w-0">
                        ...
                        {/* Nội dung: bỏ line-clamp, wrap đẹp và giữ xuống dòng */}
